...
def letter_stat(our_str):
    """
    Функция считает количество вхождений каждой буквы в строке
    ...
    letters_dict = {}
    # Разбиваем слово на массив
    arr_chars = list(our_str)
    # Цикл перебора массива символов
    for element in arr_chars:
        # Количество вхождений символа
        count_char_in_str = arr_chars.count(element)
        # Производим запись в словарь нужного значения, где
        # element - ключ(символ),
        # count_char_in_str - значения (количество вхождений)
        letters_dict[element] = count_char_in_str
    return letters_dict

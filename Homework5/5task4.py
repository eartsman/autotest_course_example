...
def scrabble(word):
    """
    Функция считает количество очков за слово, учитывая, что
    за каждую букву полагается заданное количество очков.
    :param word: строка для подсчета очков
    :return: суммарное количество очков
    """
    char_points = {
        1: 'авеёинорст',
        2: 'дклмпу',

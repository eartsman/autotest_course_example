...
# Здесь пишем код
class Segment:
    def __init__(self, cortege1, cortege2):
        self.cortege1 = cortege1
        self.cortege2 = cortege2

    def length(self):
        len_d = (((self.cortege2[0] - self.cortege1[0])**2) + ((self.cortege2[1] - self.cortege1[1])**2))**0.5
        return round(len_d, 2)

    def x_axis_intersection(self):
        if (self.cortege1[1] * self.cortege2[1]) <= 0:
            return True
        return False

    def y_axis_intersection(self):
        if (self.cortege1[0] * self.cortege2[0]) <= 0:
            return True
        return False
